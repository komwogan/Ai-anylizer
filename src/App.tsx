...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-navy-dark overflow-x-hidden selection:bg-green-accent selection:text-navy-dark">
          ...
          {['Home', 'Pricing', 'Blog', 'Contact'].map(item => (
            <button 
              ...
              className={cn(
                ...
                activePage === item.toLowerCase() ? "text-green-accent" : "text-gray-400"
              )}
            >
              {item}
            </button>
               ...
               {['Home', 'Pricing', 'Blog', 'Contact'].map(item => (
                <button 
                  ...
                  className={cn(
                    ...
                    activePage === item.toLowerCase() ? "text-green-accent" : "text-white"
                  )}
                >
                  {item}
                </button>
      ...
      {/* 9. FAQ SECTION */}
      <section id="contact" className="py-24 px-6 md:px-12 lg:px-24 bg-navy-light/10">
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24">
        ...
        {/* --- BLOG PAGE --- */}
        {activePage === 'blog' && (
          <section className="py-24 px-6 md:px-12 lg:px-24 max-w-6xl mx-auto min-h-[60vh]">
        ...
        {/* --- CONTACT PAGE --- */}
        {activePage === 'contact' && (
          <section className="py-24 px-6 md:px-12 lg:px-24 min-h-[60vh]">
        ...
        {activePage === 'pricing' && (
          <div className="py-12 min-h-[60vh]">
            <section id="pricing" className="py-24 px-6 md:px-12 lg:px-24 text-center">
      ...
      <footer className="py-20 px-6 md:px-12 lg:px-24 border-t border-white/5 bg-navy-dark sticky bottom-0 -z-10">
